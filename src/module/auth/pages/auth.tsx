...
export default function AuthPage() {
  return (
    <div className="w-full h-screen flex items-center justify-center ">
      <SEO
        title="Member Access"
        description="Sign in to your Rentlo account or create a new one to start managing your properties and visit schedules."
      />
          ...
          <div className="">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-10 text-white z-10 translate-y-0 transition-transform duration-500">
              ...
              <p className="text-gray-300 text-sm leading-relaxed max-w-sm">
                The modern way to track users, visits, and property metrics with
